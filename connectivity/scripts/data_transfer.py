...
def from_savio():
    ...
    os.system("rsync -avrz maedbhking@dtn.brc.berkeley.edu:/global/scratch/users/maedbhking/projects/cerebellum_connectivity/data/sc2/conn_models/eval/eval_summary_mk2.csv /Users/maedbhking/Documents/cerebellum_connectivity/data/sc2/conn_models/eval/")
