...
space['rank']=[1,2,3,4,5,6,7]
space['lambda_cor'] = loguniform(1e-5, 1e4)
space['lambda_cere'] = loguniform(1e-5, 1e4)
space['alpha_cor'] = loguniform(1e-5, 1e4)
space['alpha_cere'] = loguniform(1e-5, 1e4)
...
pd.DataFrame(result.cv_results_).to_csv("cv_results_logunifom.csv")
